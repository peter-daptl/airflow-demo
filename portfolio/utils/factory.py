from portfolio.utils.exceptions import FactoryException


class Factory:
    @classmethod
    def create_subclass(
        cls, base, prefix, use_base=False, default=False, *args, **kwargs
    ):
        ...
        try:
            ...
            if not use_base and not default:
                raise FactoryException(
                    f"Could not find {base.__name__} for prefix: {prefix}"
                )
